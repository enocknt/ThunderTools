...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_76e98819InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_76e98819{};
            ProxyStub::UnknownProxy* _parameter_76e98819Proxy__ = nullptr;
            if (_parameter_76e98819InstanceId__ != 0) {
                _parameter_76e98819Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_76e98819InstanceId__, false, _parameter_76e98819);
                ASSERT((_parameter_76e98819 != nullptr) && (_parameter_76e98819Proxy__ != nullptr));
            }

            implementation->Activated(_parameter_76e98819);

            if (_parameter_76e98819Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_76e98819Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_2351e9e0InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_2351e9e0{};
            ProxyStub::UnknownProxy* _parameter_2351e9e0Proxy__ = nullptr;
            if (_parameter_2351e9e0InstanceId__ != 0) {
                _parameter_2351e9e0Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2351e9e0InstanceId__, false, _parameter_2351e9e0);
                ASSERT((_parameter_2351e9e0 != nullptr) && (_parameter_2351e9e0Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_2351e9e0);

            if (_parameter_2351e9e0Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_2351e9e0Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_cef492e6InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_cef492e6{};
            ProxyStub::UnknownProxy* _parameter_cef492e6Proxy__ = nullptr;
            if (_parameter_cef492e6InstanceId__ != 0) {
                _parameter_cef492e6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_cef492e6InstanceId__, false, _parameter_cef492e6);
                ASSERT((_parameter_cef492e6 != nullptr) && (_parameter_cef492e6Proxy__ != nullptr));
            }

            implementation->Terminated(_parameter_cef492e6);

            if (_parameter_cef492e6Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_cef492e6Proxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_76e98819) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_76e98819));
        ...
        void Deactivated(IRemoteConnection* _parameter_2351e9e0) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2351e9e0));
        ...
        void Terminated(IRemoteConnection* _parameter_cef492e6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_cef492e6));
