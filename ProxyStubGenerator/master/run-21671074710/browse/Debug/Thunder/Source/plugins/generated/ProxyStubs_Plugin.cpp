...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler CompositPluginStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_95691b87InstanceId__ = reader.Number<Core::instance_id>();

            ICompositPlugin::ICallback* _parameter_95691b87{};
            ProxyStub::UnknownProxy* _parameter_95691b87Proxy__ = nullptr;
            if (_parameter_95691b87InstanceId__ != 0) {
                _parameter_95691b87Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_95691b87InstanceId__, false, _parameter_95691b87);
                ASSERT((_parameter_95691b87 != nullptr) && (_parameter_95691b87Proxy__ != nullptr));
            }

            uint32_t result = implementation->Callback(_parameter_95691b87);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_95691b87Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_95691b87Proxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Callback(ICompositPlugin::ICallback* _parameter_95691b87) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_95691b87));
