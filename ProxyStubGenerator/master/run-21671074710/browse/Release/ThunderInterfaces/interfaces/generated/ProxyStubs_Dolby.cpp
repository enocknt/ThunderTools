...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_a194a349InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_a194a349{};
                ProxyStub::UnknownProxy* _parameter_a194a349Proxy__ = nullptr;
                if (_parameter_a194a349InstanceId__ != 0) {
                    _parameter_a194a349Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a194a349InstanceId__, false, _parameter_a194a349);
                    ASSERT((_parameter_a194a349 != nullptr) && (_parameter_a194a349Proxy__ != nullptr));
                    if ((_parameter_a194a349 == nullptr) || (_parameter_a194a349Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_a194a349);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_a194a349Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_a194a349Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_fb9b4a2aInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_fb9b4a2a{};
                ProxyStub::UnknownProxy* _parameter_fb9b4a2aProxy__ = nullptr;
                if (_parameter_fb9b4a2aInstanceId__ != 0) {
                    _parameter_fb9b4a2aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fb9b4a2aInstanceId__, false, _parameter_fb9b4a2a);
                    ASSERT((_parameter_fb9b4a2a != nullptr) && (_parameter_fb9b4a2aProxy__ != nullptr));
                    if ((_parameter_fb9b4a2a == nullptr) || (_parameter_fb9b4a2aProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_fb9b4a2a);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_fb9b4a2aProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_fb9b4a2aProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_a194a349) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a194a349));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_a194a349), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_fb9b4a2a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fb9b4a2a));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_fb9b4a2a), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
