...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_b850408bInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_b850408b{};
                ProxyStub::UnknownProxy* _parameter_b850408bProxy__ = nullptr;
                if (_parameter_b850408bInstanceId__ != 0) {
                    _parameter_b850408bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b850408bInstanceId__, false, _parameter_b850408b);
                    ASSERT((_parameter_b850408b != nullptr) && (_parameter_b850408bProxy__ != nullptr));
                    if ((_parameter_b850408b == nullptr) || (_parameter_b850408bProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_b850408b);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_b850408bProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_b850408bProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_6c9782fbInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_6c9782fb{};
                ProxyStub::UnknownProxy* _parameter_6c9782fbProxy__ = nullptr;
                if (_parameter_6c9782fbInstanceId__ != 0) {
                    _parameter_6c9782fbProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_6c9782fbInstanceId__, false, _parameter_6c9782fb);
                    ASSERT((_parameter_6c9782fb != nullptr) && (_parameter_6c9782fbProxy__ != nullptr));
                    if ((_parameter_6c9782fb == nullptr) || (_parameter_6c9782fbProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_6c9782fb);

                if (_parameter_6c9782fbProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_6c9782fbProxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_a9ca834cInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_a9ca834c{};
                ProxyStub::UnknownProxy* _parameter_a9ca834cProxy__ = nullptr;
                if (_parameter_a9ca834cInstanceId__ != 0) {
                    _parameter_a9ca834cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a9ca834cInstanceId__, false, _parameter_a9ca834c);
                    ASSERT((_parameter_a9ca834c != nullptr) && (_parameter_a9ca834cProxy__ != nullptr));
                    if ((_parameter_a9ca834c == nullptr) || (_parameter_a9ca834cProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_a9ca834c);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_a9ca834cProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_a9ca834cProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_b850408b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b850408b));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_b850408b), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_6c9782fb) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_6c9782fb));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_6c9782fb), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_a9ca834c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a9ca834c));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_a9ca834c), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
