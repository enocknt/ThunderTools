...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_f94c09efInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_f94c09ef{};
                ProxyStub::UnknownProxy* _parameter_f94c09efProxy__ = nullptr;
                if (_parameter_f94c09efInstanceId__ != 0) {
                    _parameter_f94c09efProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_f94c09efInstanceId__, false, _parameter_f94c09ef);
                    ASSERT((_parameter_f94c09ef != nullptr) && (_parameter_f94c09efProxy__ != nullptr));
                    if ((_parameter_f94c09ef == nullptr) || (_parameter_f94c09efProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_f94c09ef);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_f94c09efProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_f94c09efProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_795cd0abInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_795cd0ab{};
                ProxyStub::UnknownProxy* _parameter_795cd0abProxy__ = nullptr;
                if (_parameter_795cd0abInstanceId__ != 0) {
                    _parameter_795cd0abProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_795cd0abInstanceId__, false, _parameter_795cd0ab);
                    ASSERT((_parameter_795cd0ab != nullptr) && (_parameter_795cd0abProxy__ != nullptr));
                    if ((_parameter_795cd0ab == nullptr) || (_parameter_795cd0abProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_795cd0ab);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_795cd0abProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_795cd0abProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_f94c09ef) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f94c09ef));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_f94c09ef), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_795cd0ab) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_795cd0ab));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_795cd0ab), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
