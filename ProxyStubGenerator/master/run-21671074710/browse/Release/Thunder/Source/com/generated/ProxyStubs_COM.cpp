...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_a5603c03InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_a5603c03{};
                ProxyStub::UnknownProxy* _parameter_a5603c03Proxy__ = nullptr;
                if (_parameter_a5603c03InstanceId__ != 0) {
                    _parameter_a5603c03Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a5603c03InstanceId__, false, _parameter_a5603c03);
                    ASSERT((_parameter_a5603c03 != nullptr) && (_parameter_a5603c03Proxy__ != nullptr));
                    if ((_parameter_a5603c03 == nullptr) || (_parameter_a5603c03Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_a5603c03);

                if (_parameter_a5603c03Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_a5603c03Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_38075da8InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_38075da8{};
                ProxyStub::UnknownProxy* _parameter_38075da8Proxy__ = nullptr;
                if (_parameter_38075da8InstanceId__ != 0) {
                    _parameter_38075da8Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_38075da8InstanceId__, false, _parameter_38075da8);
                    ASSERT((_parameter_38075da8 != nullptr) && (_parameter_38075da8Proxy__ != nullptr));
                    if ((_parameter_38075da8 == nullptr) || (_parameter_38075da8Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_38075da8);

                if (_parameter_38075da8Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_38075da8Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_86d41a41InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_86d41a41{};
                ProxyStub::UnknownProxy* _parameter_86d41a41Proxy__ = nullptr;
                if (_parameter_86d41a41InstanceId__ != 0) {
                    _parameter_86d41a41Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_86d41a41InstanceId__, false, _parameter_86d41a41);
                    ASSERT((_parameter_86d41a41 != nullptr) && (_parameter_86d41a41Proxy__ != nullptr));
                    if ((_parameter_86d41a41 == nullptr) || (_parameter_86d41a41Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_86d41a41);

                if (_parameter_86d41a41Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_86d41a41Proxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_a5603c03) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a5603c03));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_a5603c03), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_38075da8) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_38075da8));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_38075da8), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_86d41a41) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_86d41a41));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_86d41a41), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
