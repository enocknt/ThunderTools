...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeAVNClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_4b2f678fInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_4b2f678f{};
            ProxyStub::UnknownProxy* _parameter_4b2f678fProxy__ = nullptr;
            if (_parameter_4b2f678fInstanceId__ != 0) {
                _parameter_4b2f678fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4b2f678fInstanceId__, false, _parameter_4b2f678f);
                ASSERT((_parameter_4b2f678f != nullptr) && (_parameter_4b2f678fProxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_4b2f678f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4b2f678fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4b2f678fProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_3697e937 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_3697e937));
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_4b2f678f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4b2f678f));
        ...
        void Launch(const string& _parameter_3697e937) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_3697e937);
