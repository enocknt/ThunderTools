...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_5189363aInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_5189363a{};
            ProxyStub::UnknownProxy* _parameter_5189363aProxy__ = nullptr;
            if (_parameter_5189363aInstanceId__ != 0) {
                _parameter_5189363aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5189363aInstanceId__, false, _parameter_5189363a);
                ASSERT((_parameter_5189363a != nullptr) && (_parameter_5189363aProxy__ != nullptr));
            }

            implementation->Callback(_parameter_5189363a);

            if (_parameter_5189363aProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_5189363aProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_5189363a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5189363a));
