...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_504317ee = reader.Text();
            const string _parameter_8bdcc498 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_504317ee), static_cast<const string&>(_parameter_8bdcc498));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_504317ee, const string& _parameter_8bdcc498) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_504317ee);
            writer.Text(_parameter_8bdcc498);
