...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeCompositionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                const Exchange::IComposition::ScreenResolution _parameter_48ab2019 = reader.Number<Exchange::IComposition::ScreenResolution>();

                uint32_t result = implementation->Resolution(_parameter_48ab2019);
    ...
    static ProxyStub::MethodHandler ExchangeCompositionDisplayStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<Exchange::IComposition::ScreenResolution>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const Exchange::IComposition::ScreenResolution _parameter_105da9dd = reader.Number<Exchange::IComposition::ScreenResolution>();

                uint32_t result = implementation->Resolution(_parameter_105da9dd);
    ...
    public:
        ...
        uint32_t Resolution(const Exchange::IComposition::ScreenResolution _parameter_48ab2019) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IComposition::ScreenResolution>(_parameter_48ab2019);
    ...
    public:
        ...
        uint32_t Resolution(const Exchange::IComposition::ScreenResolution _parameter_105da9dd) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IComposition::ScreenResolution>(_parameter_105da9dd);
