...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_0c7d6704InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_0c7d6704{};
            ProxyStub::UnknownProxy* _parameter_0c7d6704Proxy__ = nullptr;
            if (_parameter_0c7d6704InstanceId__ != 0) {
                _parameter_0c7d6704Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_0c7d6704InstanceId__, false, _parameter_0c7d6704);
                ASSERT((_parameter_0c7d6704 != nullptr) && (_parameter_0c7d6704Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_0c7d6704);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_0c7d6704Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_0c7d6704Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_1dc46a69InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_1dc46a69{};
            ProxyStub::UnknownProxy* _parameter_1dc46a69Proxy__ = nullptr;
            if (_parameter_1dc46a69InstanceId__ != 0) {
                _parameter_1dc46a69Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1dc46a69InstanceId__, false, _parameter_1dc46a69);
                ASSERT((_parameter_1dc46a69 != nullptr) && (_parameter_1dc46a69Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_1dc46a69);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_1dc46a69Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_1dc46a69Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_0c7d6704) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0c7d6704));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_1dc46a69) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1dc46a69));
