...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_346258bfInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_346258bf{};
            ProxyStub::UnknownProxy* _parameter_346258bfProxy__ = nullptr;
            if (_parameter_346258bfInstanceId__ != 0) {
                _parameter_346258bfProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_346258bfInstanceId__, false, _parameter_346258bf);
                ASSERT((_parameter_346258bf != nullptr) && (_parameter_346258bfProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_346258bf);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_346258bfProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_346258bfProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_4ef5a47aInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_4ef5a47a{};
            ProxyStub::UnknownProxy* _parameter_4ef5a47aProxy__ = nullptr;
            if (_parameter_4ef5a47aInstanceId__ != 0) {
                _parameter_4ef5a47aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4ef5a47aInstanceId__, false, _parameter_4ef5a47a);
                ASSERT((_parameter_4ef5a47a != nullptr) && (_parameter_4ef5a47aProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_4ef5a47a);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4ef5a47aProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4ef5a47aProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_346258bf) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_346258bf));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_4ef5a47a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4ef5a47a));
