...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_56961879InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_56961879{};
            ProxyStub::UnknownProxy* _parameter_56961879Proxy__ = nullptr;
            if (_parameter_56961879InstanceId__ != 0) {
                _parameter_56961879Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_56961879InstanceId__, false, _parameter_56961879);
                ASSERT((_parameter_56961879 != nullptr) && (_parameter_56961879Proxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_56961879);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_56961879Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_56961879Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_4da13ae2InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_4da13ae2{};
            ProxyStub::UnknownProxy* _parameter_4da13ae2Proxy__ = nullptr;
            if (_parameter_4da13ae2InstanceId__ != 0) {
                _parameter_4da13ae2Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4da13ae2InstanceId__, false, _parameter_4da13ae2);
                ASSERT((_parameter_4da13ae2 != nullptr) && (_parameter_4da13ae2Proxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_4da13ae2);

            if (_parameter_4da13ae2Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4da13ae2Proxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_bf464837InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_bf464837{};
            ProxyStub::UnknownProxy* _parameter_bf464837Proxy__ = nullptr;
            if (_parameter_bf464837InstanceId__ != 0) {
                _parameter_bf464837Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bf464837InstanceId__, false, _parameter_bf464837);
                ASSERT((_parameter_bf464837 != nullptr) && (_parameter_bf464837Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_bf464837);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_bf464837Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_bf464837Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_56961879) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_56961879));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_4da13ae2) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4da13ae2));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_bf464837) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bf464837));
